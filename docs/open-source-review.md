...
|---|---|---|---|
| OpenCV 4.11.0 | Bundled OpenCV.js and twenty pinned custom ArUco marker patterns generated by `extendDictionary(20, 4)` | Apache-2.0 | `NOTICE`; source header in `client/src/lib/calibrate/aruco-4x4.ts` |
