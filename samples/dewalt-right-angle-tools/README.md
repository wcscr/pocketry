...
- **Base:** Gridfinity.
- **Print model:** [dewalt-right-angle-tools.3mf](dewalt-right-angle-tools.3mf).
- **Editable project:** [dewalt-right-angle-tools.pocketry.json](dewalt-right-angle-tools.pocketry.json).
